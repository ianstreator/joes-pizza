const PizzaData = {
  BuildYourOwnPizza: {
    Size: ['10"', '12"', '14"', '16"', '18"'],
    Crust: {
      "X-Thin": ["$10.00", "$12.00", "$14.00", "$16.00", "$18.00"],
      Thin: ["$10.00", "$12.00", "$14.00", "$16.00", "$18.00"],
      ...
      "Pan Pizza": [null, "$17.00", null, "$24.00", null],
      "Chicago Style Deep Dish": [null, "$17.00", null, "$24.00", null],
      "The Original Stuffed Joe": [null, "$17.00", null, "$24.00", null],
      'Gluten Free 12" Only': [null, "$12.00", null, null, null],
    },
    Toppings: [
      "Sausage",
      "Green Peppers",
